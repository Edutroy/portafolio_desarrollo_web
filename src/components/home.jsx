  ...
  return (
    <div className='w-full justify-center h-screen bg-image bg-no-repeat bg-cover flex flex-col items-center  '>
        ...
        />
          ...
          <section className='flex items-center justify-center'> <h5 className =" py-4 font-signature text-3xl text-cyan-400">Portafolio </h5>
          <div className="w-4"></div> <h5 className =" py-4 font-signature text-3xl text-cyan-400">   Desarrollador web</h5></section>
     
      <section className=' px-48 text-center backdrop-blur-sm'>
